...
$pdf->SetFont('Arial','', 10);
$pdf->SetXY(137,25);
$pdf->Cell(100, 4, utf8_decode($_POST['codigo']), 0, 'J');
...
$pdf->SetFont('Arial','', 10);
$pdf->SetXY(201,25);
$pdf->Cell(100, 4, utf8_decode($_POST['revision']), 0, 'J');
...
$pdf->SetFont('Arial','', 10);
$pdf->SetXY(240,25);
$pdf->Cell(70, 4, utf8_decode($_POST['fecha']), 0, 'J');
...
$pdf->SetXY(10, 46);
$pdf->Cell(128, 6, utf8_decode($_POST['responsable']), 1,0, 'C');
...
//borde ASIGNATURA
$pdf->SetXY(10, 55);
$pdf->Cell(128, 6, utf8_decode($_POST['asignatura']), 1,0, 'C');
...
//borde division
$pdf->SetXY(10, 61);
$pdf->Cell(90, 9, utf8_decode(''), 1,0, 'C');
...
//borde CARRERA
$pdf->SetXY(100, 61);
$pdf->Cell(38, 9, utf8_decode(''), 1,0, 'C');
...
//borde HT
$pdf->SetXY(138, 55);
$pdf->Cell(40, 6, utf8_decode($_POST['horasTrabajo']), 1,0, 'C');
...
//borde HP
$pdf->SetXY(178, 55);
$pdf->Cell(25, 6, utf8_decode($_POST['horasPracticas']), 1,0, 'C');

//texto GRUPO
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(180,64);
$pdf->Cell(10, 4, utf8_decode('GRUPO: '.$_POST['grupo']), 0, 'C');

//borde grupo
$pdf->SetXY(178, 61);
$pdf->Cell(50, 9, utf8_decode(''), 1,0, 'C');
...
//borde C
$pdf->SetXY(203, 55);
$pdf->Cell(25, 6, utf8_decode($_POST['creditos']), 1,0, 'C');
...
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(232,56);
$pdf->Cell(10, 4, utf8_decode('HOJA:      1        de       9'), 0, 'C');
...
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(232,64);
$pdf->Cell(10, 4, utf8_decode('PERIODO: '.$_POST['periodoInicio']."-".$_POST['periodoFin']), 0, 'C');
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
//borde PERIODO
$pdf->SetXY(228, 61);
$pdf->Cell(57, 9, utf8_decode(''), 1,0, 'C'); 

//texto objetivos el curso
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(10,74);
$pdf->Multicell(270, 3.5, utf8_decode('OBJETIVOS DEL CURSO: '.
 $_POST['objetivoDelCurso']), 0,1, 'J', true);

//borde objetivos
$pdf->SetXY(10, 72);
$pdf->Cell(275, 20, utf8_decode(''), 1,0, 'C');

//texto aportacion
$pdf->SetFillColor(255,255,255);
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(10,95);
$pdf->Multicell(270, 3.5, utf8_decode('APORTACIÓN DEL CURSO AL PERFIL PROFESIONAL: '.$_POST['perfilProfesional']), 0,1, 'J' ,true);

//borde APORTACION
$pdf->SetXY(10, 93);
$pdf->Cell(275, 21, utf8_decode(''), 1,0, 'C'); 
...
//borde ANTERIORES
$pdf->SetXY(10, 127);
$pdf->Cell(160, 28, utf8_decode($_POST['temaAnterior']), 1,0, 'C'); 
...
//borde ANTERIORES
$pdf->SetXY(170, 127);
$pdf->Cell(115, 28, utf8_decode($_POST['asignaturaAnterior']), 1,0, 'C'); 

$pdf->RotarTexto(15,183,'POSTERIORES',90);

//borde posteriores
$pdf->SetXY(10, 155);
$pdf->Cell(160, 30, utf8_decode($_POST['temaPosterior']), 1,0, 'C'); 
...
//borde posteriores
$pdf->SetXY(170, 155);
$pdf->Cell(115, 30, utf8_decode($_POST['asignaturaPosterior']), 1,0, 'C'); 
