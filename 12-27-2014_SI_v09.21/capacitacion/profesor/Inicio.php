<?php 
	...
	if (isset($_SESSION["sesion"]))
	{
		...
		$consulta="select nombre from Profesor where matricula ='".$matricula."'";
...
<body>
<section>
  <h2> <div align="center">Instituto Tecnológico Superior Zacatecas Sur
  &nbsp;<br>
  &nbsp;<br>
  <img src="../pic/user.png" width="234" height="256"></div></h2>
  <div align="center">
