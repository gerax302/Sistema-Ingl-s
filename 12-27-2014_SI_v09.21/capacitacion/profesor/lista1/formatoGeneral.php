...
$pdf->SetFont('Arial','', 10);
$pdf->SetXY(137,25);
$pdf->Cell(100, 4, utf8_decode('codigo'), 0, 'J');
...
$pdf->SetFont('Arial','', 10);
$pdf->SetXY(201,25);
$pdf->Cell(100, 4, utf8_decode('revision'), 0, 'J');
...
$pdf->SetFont('Arial','', 10);
$pdf->SetXY(240,25);
$pdf->Cell(70, 4, utf8_decode('fecha'), 0, 'J');
...
//borde ASIGNATURA
$pdf->SetXY(10, 55);
$pdf->Cell(128, 6, utf8_decode('asignatura'), 1,0, 'C');
...
//borde HT
$pdf->SetXY(138, 55);
$pdf->Cell(40, 6, utf8_decode('horasTrabajo'), 1,0, 'C');
...
//borde HP
$pdf->SetXY(178, 55);
$pdf->Cell(25, 6, utf8_decode('horasPracticas'), 1,0, 'C');

//texto GRUPO
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(180,64);
$pdf->Cell(10, 4, utf8_decode('GRUPO: '.'grupo'), 0, 'C');
...
//borde C
$pdf->SetXY(203, 55);
$pdf->Cell(25, 6, utf8_decode('creditos'), 1,0, 'C');
...
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(232,64);
$pdf->Cell(10, 4, utf8_decode('PERIODO: '.'periodoInicio'."-".'periodoFin'), 0, 'C');
...
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(10,72);
$pdf->Cell(20, 18, utf8_decode('OBJETIVOS DEL CURSO: '. 'objetivoDelCurso'),0, 'J');
...
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(10,91);
$pdf->Cell(20, 18, utf8_decode('APORTACIÓN DEL CURSO AL PERFIL PROFESIONAL: '.'perfilProfesional'),0, 'J');
...
//borde ANTERIORES
$pdf->SetXY(10, 127);
$pdf->Cell(160, 28, utf8_decode('temaAnterior'), 1,0, 'C'); 
...
//borde ANTERIORES
$pdf->SetXY(170, 127);
$pdf->Cell(115, 28, utf8_decode('asignaturaAnterior'), 1,0, 'C'); 

$pdf->RotarTexto(15,183,'POSTERIORES',90);

//borde posteriores
$pdf->SetXY(10, 155);
$pdf->Cell(160, 30, utf8_decode('temaPosterior'), 1,0, 'C'); 
...
//borde posteriores
$pdf->SetXY(170, 155);
$pdf->Cell(115, 30, utf8_decode('asignaturaPosterior'), 1,0, 'C'); 
