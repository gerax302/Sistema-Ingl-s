...
<body>
<section>
  <h2> <div align="center">Consultar Calificaciones Por Grupo</div></h2>
 <form method="post" name="form" action="Logica_Alta_Calificaciones1.php?tipoconsulta=consulta">
    <p>&nbsp;</p>
...
<input type="text" name="nivgr" id="nivgr" value="" hidden>
	...
	$agarraId=$_GET['idgr'];?>
     ...
     &grupo=<?php echo $agarraId;?>&nivel=<?php echo $nivelado;?>&grupillos=<?php echo $grupillos;?>">
    <p>&nbsp;</p>
