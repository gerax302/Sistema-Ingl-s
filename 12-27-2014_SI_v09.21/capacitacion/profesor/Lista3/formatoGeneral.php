...
$pdf->SetFont('Arial','', 10);
$pdf->SetXY(67,30);
$pdf->Cell(100, 4, utf8_decode($_POST['responsable']), 0, 'J');
...
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(10,72);
$pdf->Cell(20, 18, utf8_decode('OBJETIVOS DEL CURSO: '. $_POST['objetivoDelCurso']),0, 'J');
...
$pdf->SetFont('Arial','B', 10);
$pdf->SetXY(10,91);
$pdf->Cell(20, 18, utf8_decode('APORTACIÓN DEL CURSO AL PERFIL PROFESIONAL: '.$_POST['perfilProfesional']),0, 'J');
