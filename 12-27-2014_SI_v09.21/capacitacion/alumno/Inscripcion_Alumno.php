...
<html>
	...
	<body>
		<section>
			<h2>
				<div align="center">Inscripción Alumno </div>
			</h2>
			<p>
			<form method="post" name="form1" action="Logica_Inscripcion_Alumno.php">
				<p>&nbsp;</p>
				<table align="center">
					<tr valign="baseline">
						<td nowrap align="right">Número de Control:</td>
						<td><input type="text" pattern="[a-z| A-Z |0-9]*$" name="NumeroControl" value="" size="32" maxlength="45" placeholder="Ej. Z11020033" required>
...
while($row = mysql_fetch_array($buscandoNiveles))
{
	...
	$i=$i+1;
		...
		<tr valign="baseline">
			...
			<td><select name="planEstudio" id="select">
				<option value="0" id="0"> ------
				<option value="1" id="1"> Escolarizado
				<option value="2" id="2"> Semi-escolarizado Tlaltenango
				<option value="2" id="2"> Semi-escolarizado Teúl
				</select>
				<span class="poi">*</span></td>
		</td>
	<tr valign="baseline">
...
<tr>
	...
	<td><label for="select"></label>
		<select name="comboPreguntas" id="comboPreguntas">
			<option value="0" id="0"> -----------------------
			<option value="¿Cuál es el nombre de  tu canción favorita?" id="¿Cuál es el nombre de  tu canción favorita?"> ¿Cuál es el nombre de  tu canción favorita?
			<option value="¿Cuál es el lugar de nacimiento de tu madre?" id="¿Cuál es el lugar de nacimiento de tu madre?"> ¿Cuál es el lugar de nacimiento de tu madre?
			<option value="¿Cuál es el nombre de  tu mejor amigo de la infancia?" id="¿Cuál es el nombre de  tu mejor amigo de la infancia?"> ¿Cuál es el nombre de  tu mejor amigo de la infancia?
			<option value="¿Cuál es el nombre de  tu primer mascota?" id="¿Cuál es el nombre de  tu primer mascota?"> ¿Cuál es el nombre de  tu primer mascota?
			<option value="¿Cuál fué tu primer trabajo?" id="¿Cuál fué tu primer trabajo?"> ¿Cuál fué tu primer trabajo?
		</select>
		<span class="poi">*</span></td>
</tr>
<tr>
	...
	<td><input type="text" name="cajaRespuesta" id="cajaRespuesta">
		<span class="poi">*</span></td>
</tr>
<tr valign="baseline">
